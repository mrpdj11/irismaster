...
<?php
$date = date('Y-m-d');
$db_str = $db->query('SELECT * from tb_picklist  GROUP BY document_no')->fetch_all();

//print_r_html($db_str);


// print_r_html($all_str);
?>
<div class="row">
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Allocated Documents</h4>
              </div>
              <div class="card-body">
                  ...
                  <table id="example4" class="display" style="min-width: 845px">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="align-middle text-center font-weight-bold ">View Details</th>
                      ...
                      <?php foreach ($db_str as $arr_key => $arr_val) { ?>
                        <tr>
                          ...
                          <td class="align-middle text-center">
                            <a target="_blank" href="<?php echo "inventory_allocated_details?document_no={$arr_val['document_no']}" ?>" class="btn btn-outline-primary btn-md">Open</i></a>
                          </td>
                        </tr>
                      <?php
                      }
