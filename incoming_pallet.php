      ...
      <div class="container-fluid">
        <div class="row justify-content-md-center">
            <div class="col-lg-6">
                ...
                <div class="card-body">
                    <h5 class="card-title">Incoming Pallet</h5>
                    <p class="card-text">Create Pallet Receiving Transaction</p>
                        <div class="form-validation">
                            <form action="incoming_pallet_proc" method="post" class="needs-validation" novalidate>
                            <div class="form-group">
                                ...
                                <div class="row mt-1">
                                    <div class="col-lg-6 col-md-6">
                                        <label class="col-form-label text-primary font-weight-bold text-uppercase" for="inb_reference_no">Enter Inbound Goods Receipt Reference No.
                                            <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" class="form-control" name="inb_reference_no" id="inb_reference_no" placeholder="Enter Inbound Reference No. / Goods Receipt Reference No." required>     
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <label class="col-form-label text-primary font-weight-bold text-uppercase" for="date_received">Date Received
                                            <span class="text-danger">*</span>
                                        </label>
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <input type="number" class="form-control" name="qty" id="qty" placeholder="Enter Quantity Received" required>
                                    </div>
                                </div>
