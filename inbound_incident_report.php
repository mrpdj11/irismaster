...
$all_items = $db->query('SELECT id,ref_no,document_no,date_created,status FROM tb_inbound WHERE status=? GROUP BY ref_no', '2')->fetch_all();
                      ...
                      <?php foreach ($all_items as $arr_key => $arr_val) { ?>
                        <tr>
                          ...
                          <td class="align-middle text-center">
                            <?php if ($arr_val['status'] == 2) {
                              echo "<span class='badge badge-danger'>Posted / Issue</span>";
                            } ?>
                          </td>
                          <td class="align-middle text-center ">
                            <!-- <a target="" data-toggle="modal" data-target="#update<?php echo $arr_val['id']; ?>" href="" class="btn btn-outline-warning btn-md" title="Update"><i class="fas fa-pen-alt"></i></a> -->


                            <a target="_blank" href="<?php echo "inbound_add_ir?document_no={$arr_val['document_no']}&ref_no={$arr_val['ref_no']}" ?>" class="btn btn-outline-primary btn-sm" title="Create Incident Report"><i class="fas fa-plus"></i></a>
                            ...
                            <div role="document" class="modal-dialog modal-dialog-centered">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <form action="update_inbound_ir_status" method="post">
                          ...
                          <div id="delete<?php echo $arr_val['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                            <div role="document" class="modal-dialog modal-dialog-centered">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <form action="delete_inbound_ir" method="post">
                                    <div class="form-group">
