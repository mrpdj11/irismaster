...
<?php
$get_lpn = $db->query('SELECT lpn FROM tb_inbound where bin_location=?', "Staging")->fetch_all();

?>
<?php

if (isset($_POST['s_lpn'])) {
          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Scan Barcode/LPN</h4>
              </div>
              <div class="card-body">
                <div class="form-validation">
                  <form action="putaway" method="post" class="needs-validation" novalidate>
                    <div class="form-group">
                      <div class="row">
                        ...
                        <!-- <div class="col-lg-4">
                          <button type="submit" class="btn btn-primary" name="btn_report">Scan</button>
                        </div> -->
                      </div>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td class="text-center "><?php echo $lpn_det['bin_location']; ?></td>
                                    ...
                                    <form action="update_bin_loc_proc" method="post">
                                      <div class="form-group">
                                        ...
                                        <div class="mt-1">
                                          ...
                                          <input type="text" name="old_loc" id="old_loc" class="form-control" value="<?php echo $lpn_det['bin_location']; ?>">
                                        </div>

                                        <!-- CURRENT LOCATION HIDDEN -->
                                        <div class="mt-1">
                                          <input type="hidden" name="old_location" id="old_location" value="<?php echo $lpn_det['bin_location']; ?>">
                                        </div>
                                        ...
                                        <div class="mt-1">
                                          ...
                                          <input type="text" name="new_location_id" id="new_location_id" class="form-control" placeholder="Enter/Select Location">
