            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="form-validation">
                  <form action="add_vendor_proc" method="post" class="needs-validation" novalidate>
                    <div class="row">
                      <div class="col-xl-6">
                        <div class="mb-3 row">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="form-control" placeholder="Enter Vendor Code" name="vend_code" id="vend_code" required />
                          </div>
                        </div>
                        <div class="mb-3 row">
                          ...
                          <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Vendor Name" name="vend_name" id="vend_name" required />
                        ...
                        <div class="mb-3 row">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="form-control" placeholder="Enter Address" name="add_name" id="add_name" required />
                          </div>
                        </div>
