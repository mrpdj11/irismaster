...
$tb_header->easyCell('REPLACEMENT FORM', 'font-size:15; font-style:B; align:C; valign:M;');
...
$tb_info->easyCell('SRP -' . $db_count_sheet['ref_no'], 'font-size:8; font-style:B; align:C; valign:M; border:B');
$tb_info->easyCell('');
$tb_info->printRow();
...
$tb_info->easyCell('Reason of Replacement:', 'font-size:8;align:L; valign:M;');
$tb_info->easyCell('', 'font-size:8; font-style:B;align:C; valign:M;border:B');
$tb_info->easyCell('');
$tb_info->printRow();
...
$tb_info->easyCell('Date Replaced:', 'font-size:8;align:L; valign:M;');
$tb_info->easyCell('', 'font-size:8; font-style:B;align:C; valign:M;border:B');
$tb_info->easyCell('');
$tb_info->printRow();
...
$tb_header = new easyTable($pdf, '{31.6,31.6,31.6,31.6,31.6,31.6}');
...
$tb_header->easyCell('Qty in Case', 'align:C; valign:M');
...
foreach ($db_count_sheet  as $aisle_key => $aisle_val) {
  ...
  $tb_header->rowStyle('border:1; paddingY:3; font-size:8');
  $tb_header->easyCell('', 'align:C');
  $tb_header->easyCell('', 'align:C');
  $tb_header->easyCell('', 'align:C');
  $tb_header->easyCell('', 'align:C');
  $tb_header->easyCell('');
...
$pdf->Output('', "REPLENISHMENT_FORM.pdf"); //To Print and to indicate the filename
