...
if (isset($_POST['btn_report'])) {
  ...
  if (empty(trim($_POST['start_date'])) || empty(trim($_POST['end_date']))) {
    ...
    $outbound_trans = get_bet_str($db, $start_date, $end_date);
  }
}
...
<body>
  ...
  <div id="main-wrapper">
    ...
    <div class="content-body">
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Outbound Report</h4>
              </div>
              <div class="card-body">
                <div class="form-validation">
                  <form action="outbound_report" method="post" class="needs-validation" novalidate>
      ...
      <?php if (!empty($outbound_trans)) { ?>
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Outbound Summary Report</h4>

                  <div class="col-lg-2 text-right">
                    <form action="export_outbound_report" method="post" name="export_excel">
                      ...
                      <div class="control-group">
                        ...
                        <a target="_blank" href="<?php echo "print_outbound_report?start_date={$start_date}&end_date={$end_date}"; ?>" class="btn btn-info">PDF</a>
                      </div>
                    ...
                    <table id="example4" class="display" style="min-width: 845px">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th class=" text-center  font-weight-bold ">Dispatch Date</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php foreach ($outbound_trans as $inbound_key => $inbound_det) { ?>
                          <tr>
                            ...
                            <td class=" text-center"><?php echo $inbound_det['item_description']; ?></td>
                            <td class=" text-center"><?php echo $inbound_det['qty_pcs']; ?></td>
                            <td class=" text-center "><?php echo $inbound_det['expiry']; ?></td>
                            <td class=" text-center"><?php echo $inbound_det['bin_loc']; ?></td>
                            <td class=" text-center"><?php echo $inbound_det['ship_date']; ?></td>
                          </tr>
                        <?php } ?>
                      </tbody>
                    </table>
