...
closed_by,
remarks
 FROM tb_incident_report WHERE status =? and transaction_type=? GROUP BY ref_no', 'Open', 'Inbound')->fetch_all();
                                ...
                                <div class="modal-body">
                                  <form action="update_inbound_ir_status" method="post">
                                    <div class="form-group">
                                      ...
                                      <!-- REF NO-->
                                      <div class="mt-1">
                                        <input type="hidden" name="source_no" id="source_no" value="<?php echo $arr_val['source_ref_no']; ?>">
                                      </div>
                                      <!-- DOC NO-->
                                      <div class="mt-1">
