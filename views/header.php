              ...
              <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <span class="d-block text-end">
                  ...
                  if ($_SESSION['user_type'] == "admin") {
                    echo "Admin";
                  } elseif ($_SESSION['user_type'] == "inbound") {
                    echo "Inbound";
                  } elseif ($_SESSION['user_type'] == "outbound") {
                    echo "Outbound";
                  } elseif ($_SESSION['user_type'] == "inventory") {
                    echo "Inventory";
                  } elseif ($_SESSION['user_type'] == "transport") {
                    echo "Transport";
                  } elseif ($_SESSION['user_type'] == "encoder") {
                    echo "Encoder";
                  } elseif ($_SESSION['user_type'] == "viewer") {
                    echo "Viewer";
                  } elseif ($_SESSION['user_type'] == "inbound checker") {
                    echo "Inbound Checker";
                  } elseif ($_SESSION['user_type'] == "outbound checker") {
                    echo "Outbound Checker";
                  } elseif ($_SESSION['user_type'] == "picker") {
                    echo "Picker";
                  } elseif ($_SESSION['user_type'] == "main guard") {
                    echo "Main Guard";
                  } elseif ($_SESSION['user_type'] == "validator") {
                    echo "Validator";
