...
$db_inbound = $db->query('SELECT id,item_code,batch_no,qty_pcs,lpn,bin_location,expiry,document_no FROM tb_inbound WHERE bin_location=?', 'Staging')->fetch_all();
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Staging Area</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table id="example4" class="display">
                    ...
                    <tbody>
                      <?php foreach ($db_inbound as $arr_key => $arr_val) { ?>
                        <tr>
