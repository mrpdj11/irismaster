    ...
    <div class="content-body">
      <div class="container-fluid">
        <?php
          ...
          WHERE a.rdd BETWEEN ? AND ?  OR a.rdd > ? AND a.do_no = ? AND a.shipment_no = ? 
          GROUP BY a.system_shipment_no
          ORDER BY a.rdd DESC ',$start_week,$end_week,$date_today,"","")->fetch_all();
                        ...
                        <tr>
                          <td>
                            <div class="d-flex">
                              ...
                              <a  data-toggle="modal" data-target="#reverse_shipment<?php echo $arr_det['id'];?>" class="btn btn-warning shadow btn-xs sharp me-1" title="Reverse Allocation"><i class="fa-solid fa-clock-rotate-left"></i></a>
                            </div>												
												  </td>
                          ...
                          <!-- MODAL FOR UPDATE ASN DETAILS-->
                          <div id="reverse_shipment<?php echo $arr_det['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                            <div role="document" class="modal-dialog modal-dialog-centered">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 id="exampleModalLabel" class="modal-title">Reverse Shipment</h4>
                                </div>
                                <div class="modal-body">
                                  <p>Are you sure you want to reverse the shipment? This cannot be undone.</p>
                                  <form action="reverse_shipment_allocation" method="post">
                                    <div class="form-group">
                                      <!-- DB REF -->
                                      <div class="mt-1">
                                        <input type="hidden" name="db_ref" id="db_ref" value="<?php echo $arr_det['ref_no']; ?>">
                                      ...
                                      <div class="mt-1">
                                        <input type="hidden" name="ship_no" id="ship_no" value="<?php echo $arr_det['system_shipment_no']; ?>">
                                      </div>   
                                    </div>
                                    <div class="modal-footer">
                                      <button type="button" data-dismiss="modal" class="btn btn-danger">Close</button>
