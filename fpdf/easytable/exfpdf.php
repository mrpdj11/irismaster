 <?php
   ...
   class exFPDF extends FPDF
   {
      ...
      public function Footer()
      {
         ...
         // Page number
         $this->Cell(0, 10, 'www.arrowgo-logistics.com ' . date('Y-m-d'), 0, 'R');
         $this->Cell(0, 10, $this->PageNo(), 0, 0, 'L');
         $this->Cell(0, -10,'Page '. $this->PageNo() . ' of {nb}', 0, 0, 'R');
      }


      public function sign_field($prepared_by)
      {
         // Position at 1.5 cm from bottom
         $this->SetY(-55);
         // Arial italic 8
         $this->SetFont('Arial', 'B', 8);
         $this->SetDrawColor(22, 84, 201);
         $this->SetLineWidth(1);
         // Page number
         $this->Cell(25, 7, '', 'T', 'R');
         $this->Cell(55, 7, 'Prepared By:', 'T', '', 'C');
         $this->Cell(55, 7, 'Verified By:', 'T', '', 'C');
         $this->Cell(55, 7, 'Received By:', 'T', '', 'C');

         $this->Ln();

         $this->SetFont('Arial', '', 7);
         $this->Cell(25, 8, 'Signature:', '', 'R');
         $this->Cell(55, 8, '__________________________', '', '', 'C');
         $this->Cell(55, 8, '__________________________', '', '', 'C');
         $this->Cell(55, 8, '__________________________', '', '', 'C');
         ...
         $this->SetFont('Arial', '', 7);
         $this->Cell(25, 6, 'Name:', '', 'R');
         $this->Cell(55, 6, $prepared_by, '', '', 'C');
         $this->Cell(55, 6, '__________________________', '', '', 'C');
         $this->Cell(55, 6, '__________________________', '', '', 'C');

         $this->Ln();

         $this->SetFont('Arial', '', 7);
         $this->Cell(25, 6, 'Designation:', '', 'R');
         $this->Cell(55, 6, '__________________________', '', '', 'C');
         $this->Cell(55, 6, '__________________________', '', '', 'C');
         $this->Cell(55, 6, '__________________________', '', '', 'C');
         ...
         $this->SetFont('Arial', '', 7);
         $this->Cell(25, 7, 'Date:', 'B', 'R');
         $this->Cell(55, 7, '__________________________', 'B', '', 'C');
         $this->Cell(55, 7, '__________________________', 'B', '', 'C');
         $this->Cell(55, 7, '__________________________', 'B', '', 'C');
      }

      public function sign_field_order($prepared_by, $ordered_by)
      {
         // Position at 1.5 cm from bottom
         $this->SetY(-55);
         // Arial italic 8
         $this->SetFont('Arial', 'B', 8);
         $this->SetDrawColor(66, 67, 68);
         $this->SetLineWidth(1.5);
         // Page number
         $this->Cell(25, 7, '', 'T', 'R');
         $this->Cell(55, 7, 'Ordered By:', 'T', '', 'C');
         $this->Cell(55, 7, 'Prepared By:', 'T', '', 'C');
         $this->Cell(55, 7, 'Received By:', 'T', '', 'C');
      ...
      public function sign_field_outbound($prepared_by)
      {
         // Position at 1.5 cm from bottom
         $this->SetY(-55);
         // Arial italic 8
         ...
         // Page number
         $this->Cell(25, 7, '', 'T', 'R');
         $this->Cell(55, 7, 'Approved By:', 'T', '', 'C');
         $this->Cell(55, 7, 'Prepared/Issued By:', 'T', '', 'C');
         $this->Cell(55, 7, 'Received By:', 'T', '', 'C');
      ...
      public function sign_field_inbound($prepared_by)
      {
         // Position at 1.5 cm from bottom
         $this->SetY(-55);
         // Arial italic 8
         $this->SetFont('Arial', 'B', 8);
         $this->SetDrawColor(51, 232, 56);
         $this->SetLineWidth(1.5);
         // Page number
         $this->Cell(25, 7, '', 'T', 'R');
         $this->Cell(55, 7, 'Approved By:', 'T', '', 'C');
      ...
      public function sign_field_pick_list($prepared_by)
      {
         // Position at 1.5 cm from bottom
         $this->SetY(-55);
         // Arial italic 8
         ...
         $this->Cell(25, 7, '', 'T', 'R');
         $this->Cell(55, 7, 'Prepared By:', 'T', '', 'C');
         $this->Cell(55, 7, 'Picked By:', 'T', '', 'C');
         $this->Cell(55, 7, 'Verified/Checked By:', 'T', '', 'C');
      ...
      public function sign_field_stock_receive($prepared_by)
      {
         // Position at 1.5 cm from bottom
         $this->SetY(-55);
         // Arial italic 8
         ...
         // Page number
         $this->Cell(25, 7, '', 'T', 'R');
         $this->Cell(55, 7, 'Prepared and Issued By:', 'T', '', 'C');
         $this->Cell(55, 7, 'Approved and Verified By:', 'T', '', 'C');
         $this->Cell(55, 7, 'Received By:', 'T', '', 'C');
      ...
      public function sign_field_pull_out($prepared_by)
      {
         // Position at 1.5 cm from bottom
         $this->SetY(-55);
         // Arial italic 8
         ...
         // Page number
         $this->Cell(25, 7, '', 'T', 'R');
         $this->Cell(55, 7, 'Issued By:', 'T', '', 'C');
         $this->Cell(55, 7, 'Item/s Prepared By:', 'T', '', 'C');
         $this->Cell(55, 7, 'Received By:', 'T', '', 'C');
      ...
      public function sign_field_otr($prepared_by)
      {
         // Position at 1.5 cm from bottom
         $this->SetY(-55);
         // Arial italic 8
         $this->SetFont('Arial', 'B', 8);
         $this->SetDrawColor(28, 86, 201);
         $this->SetLineWidth(1.5);
         // Page number
         $this->Cell(25, 7, '', 'T', 'R');
         $this->Cell(55, 7, 'Issued By:', 'T', '', 'C');
      ...
      public function sign_field_reports($prepared_by)
      {
         // Position at 1.5 cm from bottom
         $this->SetY(-55);
         // Arial italic 8
      ...
      public function print_dr_serial($arr_serial)
      {
         // Position at 1.5 cm from bottom
         $this->SetY(-80);
         // Arial italic 8
