                    ...
                    <div class="row">
                      <div class="col-xl-6">
                        <div class="mb-3 row">
                          ...
                          <div class="col-lg-6">
                            <input type="text" class="form-control" placeholder="Enter Branch Code" name="name" id="name" required />
                          </div>
                        </div>
                        <div class="mb-3 row">
                          ...
                          <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control" placeholder="Enter  Branch Name" ame="user_name" id="user_name" required />
