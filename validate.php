...
WHERE b.validator=? and b.status!=?', $_SESSION['name'], 'For DR Printing')->fetch_all();
          ...
          <div class="col-lg-8">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Validation Details</h4>
                      ...
                      <?php foreach ($picklist as $arr_key => $arr_det) { ?>
                        <tr>
                          ...
                          <td style="font-size: 10px!important;"> <?php
                                                                  ...
                                                                  echo "<b>Item Name:</b>" . "  " . "  " . $arr_det['item_description'] . "</br>";
                                                                  echo "<b>Batch Code:</b>" . "  " . "  " . $arr_det['batch_no'] . "</br>";
                                                                  echo "<b>Qty:</b>:" . "  " . "  " . $arr_det['qty_pcs'] . "</br>"; ?></td>
                            ...
                            <div role="document" class="modal-dialog modal-dialog-centered">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <form action="scan_to_validate" method="post">
                                    <div class="form-group">
                                      ...
                                      <!-- PICK ID-->
                                      <div class="mt-1">
                                        <input type="hidden" name="pick_id" id="pick_id" value="<?php echo $arr_det['pick_id']; ?>">
                                      </div>
                                      ...
                                      <!-- BATCH CODE-->
                                      <div class="mt-1">
                                        <input type="hidden" name="lpn" value="<?php echo $arr_det['lpn']; ?>">
                                      </div>
                                      <!-- BATCH CODE-->
                                      <div class="mt-1">
                                        <input type="hidden" name="loc" value="<?php echo $arr_det['bin_loc']; ?>">
                                      </div>
                                      ...
                                      <div class="mt-1">
                                        ...
                                        <input type="text" class="form-control" name="brcd" id="brcd" placeholder="Scan LPN / Item Code / Batch Code">
                                      </div>
