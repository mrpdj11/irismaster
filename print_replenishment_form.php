...
$tb_header->easyCell('REPLENISHMENT FORM', 'font-size:15; font-style:B; align:C; valign:M;');
...
$tb_info->easyCell('RP -' . $db_count_sheet['ref_no'], 'font-size:8; font-style:B; align:C; valign:M; border:B');
$tb_info->easyCell('');
$tb_info->printRow();
...
$tb_info->easyCell('Date Replenished:', 'font-size:8;align:L; valign:M;');
$tb_info->easyCell('', 'font-size:8; font-style:B;align:C; valign:M;border:B');
$tb_info->easyCell('');
$tb_info->printRow();
...
$tb_header = new easyTable($pdf, '{40,40,40,40,25,50}');
...
foreach ($db_count_sheet  as $aisle_key => $aisle_val) {
  ...
  $tb_header->rowStyle('border:1; paddingY:5; font-size:8');
