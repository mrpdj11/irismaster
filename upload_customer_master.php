          ...
          <div class="col-lg-4">
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Upload Customer</h4>
              </div>
              <div class="card-body">
                <div class="form-validation">
                  <form action="upload_customer_master_proc" method="post" name="form_csv_input" id="form_csv_input" enctype="multipart/form-data">
                    <div class="row">
