...
$db_outbound = $db->query('SELECT * FROM tb_outbound GROUP BY document_no')->fetch_all();
foreach ($db_outbound as $key_val => $arr_val) {
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Outbound Incident Report</h4>
              </div>
              <div class="card-body">
                <div class="form-validation">
                  <form class="needs-validation" novalidate method="POST" action="outbound_ir_proc">
                    <div class="row">
                      <div class="col-xl-6">
                        <div class="mb-3 row">
                      ...
                      <div class="col-xl-6">
                        <div class="mb-3 row">
                          ...
                          <div class="col-lg-6">
                            <input list="data_source" id="source_document" name="source_document" placeholder="Enter S.O/STR/TSW/P.O/Waybill No." class="form-control medium" autofocus>
                            <datalist id="data_source">
                              <?php foreach ($db_outbound as $item_key => $arr_val) { ?>
                                <option value="<?php echo $arr_val['document_no']; ?>"><?php echo $arr_val['document_no']; ?></option>
                              <?php } ?>
                            </datalist>
