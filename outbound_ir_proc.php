...
if (isset($_POST)) {
  ...
  if (empty(trim($_POST['source_document']))  || empty(trim($_POST['source'])) || empty(trim($_POST['destination'])) || empty(trim($_POST['desc'])) || is_array_has_empty_input($_POST['nature'])  || is_array_has_empty_input($_POST['f_item_id']) || is_array_has_empty_input($_POST['f_qty']) || is_array_has_empty_input($_POST['batch']) || empty($_POST['f_item_id']) || empty($_POST['f_qty']) || is_array_has_empty_input($_POST['f_remarks'])) {
  ...
  $source_doc = $db->escape_string($_POST['source_document']);
  ...
  $date = $db->escape_string($_POST['ir_date']);
